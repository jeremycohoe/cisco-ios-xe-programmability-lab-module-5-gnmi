...
**gnoi_cert -insecure -target_addr 10.1.1.5:9339 -op provision  -target_name c9300 -alsologtostderr -organization "my org" -ip_address 10.1.1.5 -time_out=10s -min_key_size=2048 -cert_id gnxi-cert -state BC -country CA -ca ./rootCA.pem  -ca_key ./rootCA.key**
